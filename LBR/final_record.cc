...
void recordfile(){
	...
	ofstream of;
	if (rewrite) {
		of.open("/home/zhouyongfan/workspace/ns3/result-pp2.record");
	} else {
		of.open("/home/zhouyongfan/workspace/ns3/result-pp2.record", ios::app);
	}
...
void gnuplot (){
	string simFolderName="/home/zhouyongfan/sim_temp/";
	stringstream si;
	ofstream of;
